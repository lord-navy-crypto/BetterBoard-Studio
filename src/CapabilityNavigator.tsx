...
import { semanticWorkspaceForCapability } from './capabilityRoutes';
...
const NAVIGATOR_ITEMS: NavigatorItem[] = [
  ...CAPABILITIES.map(capability => ({
    ...
    workspace: semanticWorkspaceForCapability(capability.id),
  ...
  ...CAPABILITY_SHORTCUTS.map(shortcut => ({
    ...
    workspace: semanticWorkspaceForCapability(shortcut.id),
...
export default function CapabilityNavigator({ onClose, onOpenCapability }: Props) {
